                        ...
                        <ul>
                            ...
                            <?php 
                                if(!isset($_SESSION['email'])) {
                                    echo '<li><a class="nav-link scrollto" href="http://localhost/Bombeiros/Login/registration.php">Login</a></li>';
                                } else {
                                    
                                    echo'<li><a href="#">Conta</a>
                                        <ul class="dropdown">
                                            <li><a href="./perfil.php">Perfil</a></li>
                                            <li><a href="http://localhost/Bombeiros/Login/logout.php">Logout</a></li>
                                        </ul>
                                    </li>';
